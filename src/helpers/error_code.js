	...
	const CODE = {
		WPT_CONNECTION_TIMEOUT: 'WPT_CONNECTION_TIMEOUT',
		...
		CONFIG_INVALID_PARAMETERS: 'CONFIG_INVALID_PARAMETERS',
		...
		CANNOT_KILL_WPT: 'CANNOT_KILL_WPT',
		WPT_REQUEST_TIMEOUT: 'WPT_REQUEST_TIMEOUT',
